...
def load_data():
    df_ygntbpro = fn.functionGetDataFromTable("ygntbpro", SUPABASE_URL, SUPABASE_KEY)
    df_target = fn.functionGetDataFromTable("target", SUPABASE_URL, SUPABASE_KEY)
    return df_ygntbpro, df_target

# Execute with spinner
with st.spinner("Connecting to Supabase and retrieving dataset..."):
    try:
        df_ygntbpro_supabase, df_target_supabase = load_data()
